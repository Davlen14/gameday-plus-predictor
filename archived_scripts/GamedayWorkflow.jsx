...
const TopNav = ({ onRun, isRunning }) => (
  <div className="h-14 bg-[#1a1a1a] border-b border-gray-800 flex items-center justify-between px-4 z-20 relative">
    ...
    <div className="flex items-center gap-2">
      <button className="px-3 py-1.5 text-xs font-medium text-gray-300 hover:text-white hover:bg-gray-800 rounded-md transition-colors">
...
const SidebarItem = ({ icon: Icon, label, type, onAdd }) => {
  ...
  return (
    <div 
      className="group flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800 cursor-grab active:cursor-grabbing border border-transparent hover:border-gray-700 transition-all mb-2"
        ...
        <div className="flex-1 relative bg-[#121212] overflow-hidden flex flex-col">
          ...
          <div className="h-[200px] bg-[#1f1f1f] border-t border-gray-800 flex flex-col z-10">
            <div className="flex items-center border-b border-gray-800">
              <button className="px-4 py-2 text-sm font-medium text-white border-b-2 border-indigo-500 bg-gray-800/50">
                Execution Logs
              </button>
