...
import { Users, ArrowLeft, Trophy, TrendingUp, Target, Award, Home, Plane, Calendar, Star, BarChart3, Zap } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative backdrop-blur-2xl border border-white/10 rounded-3xl p-12 md:p-16 shadow-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01]">
            ...
            <div className="mb-12">
              ...
              <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-8 bg-gradient-to-br from-white/[0.03] to-transparent">
                <ComparisonBar
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {/* Lane Kiffin Splits */}
                <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-6 bg-gradient-to-br from-white/[0.03] to-transparent">
                  <h3 
                    className="text-xl font-bold mb-4 flex items-center gap-2"
                    style={{ color: (laneKiffinData as CoachData).current_team.alt_color }}
                  >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(laneKiffinData as CoachData).career_stats.splits.home}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(laneKiffinData as CoachData).career_stats.splits.away}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(laneKiffinData as CoachData).career_stats.splits.neutral}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-6 bg-gradient-to-br from-white/[0.03] to-transparent">
                  <h3 
                    className="text-xl font-bold mb-4 flex items-center gap-2"
                    style={{ color: (jamesFranklinData as CoachData).current_team.alt_color }}
                  >
                    <Users className="w-5 h-5" />
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(jamesFranklinData as CoachData).career_stats.splits.home}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(jamesFranklinData as CoachData).career_stats.splits.away}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-lg bg-white/5">
                      ...
                      <span className="text-white font-light">{(jamesFranklinData as CoachData).career_stats.splits.neutral}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-8 bg-gradient-to-br from-white/[0.03] to-transparent">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-white/5">
                    ...
                    <div className="text-xl font-light text-white">{(laneKiffinData as any).career_stats.vs_ranked.vs_top10 || 'N/A'}</div>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5">
                    <div className="text-sm text-gray-400 mb-1">vs Top 10</div>
                    <div className="text-xl font-light text-white">{(jamesFranklinData as any).career_stats.vs_ranked.vs_top10 || 'N/A'}</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-6 bg-gradient-to-br from-white/[0.03] to-transparent">
                  <h3 
                    ...
                    style={{ color: (laneKiffinData as any).current_team.alt_color }}
                  >
                ...
                <div className="backdrop-blur-xl border border-white/10 rounded-2xl p-6 bg-gradient-to-br from-white/[0.03] to-transparent">
                  <h3 
                    className="text-xl font-bold mb-4"
                    style={{ color: (jamesFranklinData as any).current_team.alt_color }}
                  >
