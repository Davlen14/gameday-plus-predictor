    ...
    <GlassCard className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 border border-white/10 rounded-lg border border-white/10">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 border border-white/10 rounded-lg border border-white/10">
          <div className="w-2 h-2 bg-slate-600 rounded-full animate-pulse"></div>
          <span className="text-slate-400 text-xs font-medium">LIVE ANALYTICS</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {/* Overall EPA */}
        <div className="relative overflow-hidden rounded-lg border border-gray-600/40 p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-slate-400" />
              <span className="text-slate-400 text-sm font-semibold">Overall EPA</span>
            </div>
            <div className="px-2 py-1 border border-white/10 rounded text-slate-400 text-xs font-medium">
              {overallDiff > 0 ? `${awayTeam.name.toUpperCase()} EDGE` : `${homeTeam.name.toUpperCase()} EDGE`}
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-3 rounded-lg border border-white/10" style={{  }}>
        ...
        <div className="relative overflow-hidden rounded-lg border border-gray-600/40 p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 text-sm font-semibold">EPA Allowed</span>
            </div>
            <div className="px-2 py-1 border border-white/10 rounded text-slate-400 text-xs font-medium">
        ...
        {/* Net EPA Edge */}
        <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-emerald-500/20 to-emerald-500/5 border-2 border-white/10 p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Activity className="w-4 h-4 text-slate-400" />
              <span className="text-slate-400 text-sm font-semibold">Net EPA Edge</span>
            </div>
            <div className="w-2 h-2 bg-slate-600 rounded-full animate-pulse"></div>
          </div>
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-center">
              <div className="text-slate-400 font-bold text-3xl font-mono">+{Math.abs(overallDiff).toFixed(3)}</div>
              <div className="text-slate-500 text-xs font-medium">per play</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className=" rounded-lg p-4 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 font-semibold text-sm">Passing EPA</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-[10px] text-slate-400">{passingDiff > 0 ? awayTeam.name.substring(0, 3).toUpperCase() : homeTeam.name.substring(0, 3).toUpperCase()}</span>
        ...
        <div className=" rounded-lg p-4 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 font-semibold text-sm">Rushing EPA</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-[10px] text-slate-400">{rushingDiff > 0 ? awayTeam.name.substring(0, 3).toUpperCase() : homeTeam.name.substring(0, 3).toUpperCase()}</span>
              <svg className="w-3 h-3 text-slate-400" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
            </div>
