...
app = Flask(__name__)
# Configure CORS - allow same origin, local development, and local network access
CORS(app, origins=[
    "https://graphqlmodel-production.up.railway.app",
    "http://localhost:5173",
    "http://localhost:5555",
    "http://localhost:3000",
    "http://192.168.5.143:5173",  # Your local network IP for React frontend
    "http://192.168.5.143:5002",  # Your local network IP for Flask backend
...
def get_coaches_db_connection():
    """Get database connection to coaches_master.db"""
    return sqlite3.connect('instance/coaches_master.db')
...
def api_get_stints(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load stints', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_games(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load games', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_rankings(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load rankings', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_draft_picks(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load draft picks', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_situational_stats(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load situational stats', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_vs_coaches(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load vs coaches', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_season_analytics(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load season analytics', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_recruiting(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load recruiting classes', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_talent(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load talent composite', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_portal(coach_id: int):
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load transfer portal', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_stats():
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load stats', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_get_players():
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load players', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def api_search():
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to search', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def get_drives_teams():
    ...
    try:
        ...
        import traceback
        return jsonify({'error': 'Failed to load drives teams', 'message': str(e), 'traceback': traceback.format_exc()}), 500
...
def get_upcoming_games():
    ...
    try:
        ...
        team_colors = {}
        try:
            coaches_conn = get_coaches_db_connection()
        ...
        for row in rows:
            ...
            if espn_game_service and should_refresh:
                try:
                    espn_data = espn_game_service.get_game_for_field(str(game_id), force_refresh=should_refresh)
